...
export const oldestFirstStory: CoolStuffStoryPart[][] = [
  ...
  " because I wanted to make the game fetch items in higher quantities instead of spawning them one at a time. I started experimenting with Discord bots for my friend group at this time for anime references (like Mudae!). I tinkered with robotics in high school, first with a ",
  ...
  ", similar to Twitch chat for people watching their favorite coin. I exited.",
  ],
  [
  ...
  ". And then I got into davinci-002. It was my first model, and I spent my last $30 on inference just fiddling with it. I pitched to a professor and ended up helping build the entire pipeline for ",
  { text: "research on a text-to-video generative model" },
  ". I'm inspired by my sisters, so I wanted to pursue medicine too. I ended up starting research domestically at Carnegie Mellon for neurology, and internationally at Seoul National for genealogy. I started a new start-up with my friends, failed, and learned about ",
  { text: "language learning with assimilation" },
  ": reading, writing, typing, speaking, and conversing until you indulge yourself in the entire language. My favorite hackathon project was a ",
  ...
  " that stayed overlaid at the bottom-middle of the screen, over absolutely everything. It also had bionic reading so they could associate audio with text and get the hang of it. Then, made ",
  { text: "some stuff about checking-in with each other over an inside joke" },
  ". If one of my friends entered a certain section of California, the Bay Area, specifically Fremont or Milpitas, a ping would go to each other's phones: \"Jason just entered your territory...\" ",
  ...
  ". They were NFC tags encapsulated by cute charms that opened a Spotify playlist on a compatible device. The playlist changed every day, using an algorithm I made to converge on different genres and make them more cohesive. If you talk to me, I just might tell you more.",
  ],
];
